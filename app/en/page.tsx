...
export const metadata: Metadata = {
  title: 'TaxConsult - Accounting, Tax & Business Registration Services in Rawalpindi & Islamabad',
  description: 'TaxConsult provides expert accounting services, tax consultancy, SECP company registration, NTN & STR registration, bookkeeping, and payroll management in Rawalpindi and Islamabad. Get professional business solutions today!',
  keywords: [
  ...
  openGraph: {
    title: 'TaxConsult - Accounting, Tax & Business Registration Experts',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: 'TaxConsult Accounting and Tax Services',
      }
    ]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'TaxConsult - Accounting, Tax & Business Registration Services',
